...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .authorizeRequests()
                .antMatchers(
                        "/api/user/account/token/",   //登录接口
                        "/api/user/account/register/",          //注册接口
                ...
                .antMatchers("/api/ranklist/getlist/").permitAll()
                .antMatchers("/api/record/getlist/").permitAll()


                .antMatchers("/pk/start/game/", "/pk/receive/bot/move/").hasIpAddress("127.0.0.1")
//                .antMatchers("/pk/start/game/", "/pk/receive/bot/move/").hasIpAddress("81.70.88.73")
